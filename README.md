...
说明：
- “/”表示未检索到明确公开的 arXiv 页面或官方 GitHub/项目页面。
- 部分项目未提供 GitHub 仓库，但提供项目主页；此类链接暂列入“GitHub/项目页面”。
- 链接核对日期：2026-05-27。

## 数据集

| 数据集 | 在本文中的用途/说明 | arXiv 页面 | GitHub/项目页面 |
|---|---|---|---|
...
| DIOR | 光学遥感目标检测数据集；本文 COCO→DIOR 设置的目标域 | [arXiv](https://arxiv.org/abs/1909.00133) | / |
...
| CD-ViTO | 跨域少样本检测；增强开放集检测器 | [arXiv](https://arxiv.org/abs/2402.03094) | / |
...
| Domain-RAG | 跨域少样本检测检索增强生成 | [arXiv](https://arxiv.org/abs/2506.05872) | / |
...
| Rex-Omni | 多模态大模型目标检测/下一点预测 | [arXiv](https://arxiv.org/abs/2510.12798) | / |
